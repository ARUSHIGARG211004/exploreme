...
//   const [generatedText, setGeneratedText] = useState(null); // State to hold generated text
//   const [similarImages, setSimilarImages] = useState([]); // State to hold similar images
...
//         setGeneratedText(data.generatedText); // Set the generated text
//         setSimilarImages(data.similarImages); // Set similar images
...
//                   <img key={index} src={image} alt={`Similar Image ${index}`} width="200" height="150" />
//                 ))}
//               </div>
//             </div>
//           )}
