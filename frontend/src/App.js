...
const Home = ({ onLogout }) => (
  <div className="home-container">
    ...
    <nav className="home-nav">
      <Link to="/camera" className="nav-button camera-button nav-link">
        Camera
      </Link>
      <Link to="/upload" className="nav-button camera-button nav-link">
        Upload
      </Link>
      <Link to="/collection" className="nav-button camera-button nav-link">
        Collection
      </Link>
      <button className="nav-button camera-button nav-link" onClick={onLogout}>
        Logout
      </button>
